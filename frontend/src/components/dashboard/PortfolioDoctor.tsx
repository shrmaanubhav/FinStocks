    ...
    <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-brand-500 to-purple-600 flex items-center justify-center">
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          {/* Score label */}
          <div className={`mt-4 px-4 py-1.5 rounded-full text-sm font-medium bg-linear-to-r ${getScoreGradient(healthData.overallScore)} text-white`}>
