        ...
        <div className="relative flex lg:flex-row w-full h-screen justify-center flex-col  dark:bg-gray-900 sm:p-0">
          ...
          <div className="lg:w-1/2 w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 lg:grid items-center hidden relative overflow-hidden">
            ...
            <div className="relative items-center justify-center flex z-1">
              ...
              <div className="w-10 h-10 rounded-xl border-2 flex items-center justify-center border-gray-300 dark:border-gray-600">
                <svg className="w-7 h-7 text-gray-900 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                </svg>
              </div>
              <span className="text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
                FinStocks
              </span>
            </div>
                </Link>
